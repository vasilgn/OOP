...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fleetData = __webpack_require__(3);

	var _fleetDataService = __webpack_require__(4);

	var _applicationBase = __webpack_require__(9);

	var _homePage = __webpack_require__(12);

	var _carsPage = __webpack_require__(16);

	var _dronesPage = __webpack_require__(18);

	var _mapPage = __webpack_require__(19);
	...
	var App = exports.App = function (_ApplicationBase) {
	    ...
	    function App() {
	        ...
	        _this.addRoute('Drones', new _dronesPage.DronesPage());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataError = __webpack_require__(8);
	...
	var FleetDataService = exports.FleetDataService = function () {
	    ...
	    _createClass(FleetDataService, [{
	        ...
	        key: 'fileterCarsByMake',
	        value: function fileterCarsByMake(filter) {
	        ...
	        value: function validateCarData(car) {
	            ...
	            if (Number.isNaN(Number.parseFloat(car.miles))) {
	                this.errors.push(new _dataError.DataError('invalid mileage', car));
	                hasErrors = true;
	            }
	            return !hasErrors;
	        }
	        ...
	        value: function validateDroneData(drone) {
	            var requiredProps = 'license model latLong airTimeHours base'.split(' ');
	            var hasErrors = false;
	            ...
	            try {
	                for (var _iterator3 = requiredProps[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                    ...
	                    if (!drone[field]) {
	                        this.errors.push(new _dataError.DataError('invalid field ' + field, drone));
	                        hasErrors = true;
	                    }
	                }
	            } catch (err) {
	            ...
	            if (Number.isNaN(Number.parseFloat(drone.airTimeHours))) {
	                this.errors.push(new _dataError.DataError('invalid airTiming', drone));
	                hasErrors = true;
	            }
	            return !hasErrors;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ApplicationBase = exports.ApplicationBase = function () {
	    function ApplicationBase(title) {
	        ...
	        //KVP key is 'id' value will be 'pageObject'
	        this.routeMap = {};
	    ...
	    _createClass(ApplicationBase, [{
	        ...
	        value: function addRoute(id, pageObject) {
	            var defaultRoute = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
	...
	var HomePage = exports.HomePage = function (_Page) {
	    ...
	    _createClass(HomePage, [{
	        ...
	        value: function createElement() {
	            ...
	            var styleString = 'width: 300px; height: 80px;';
	...
	var CarsPage = exports.CarsPage = function (_Page) {
	    ...
	    _createClass(CarsPage, [{
	        ...
	        value: function createElement() {
	            ...
	            var t = new _dataTable.DataTable(headers, _app.application.dataService.cars);
	                ...
	                for (var _iterator2 = this.data[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                    ...
	                    try {
	                        for (var _iterator3 = this.headers[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                            ...
	                            var currentProp = property.toLowerCase();
	                            if (currentProp === 'airtimehours') {
	                                currentProp = 'airTimeHours';
	                            }
	                            var field = row[currentProp];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DronesPage = exports.DronesPage = function (_Page) {
	    _inherits(DronesPage, _Page);

	    function DronesPage() {
	        _classCallCheck(this, DronesPage);

	        return _possibleConstructorReturn(this, (DronesPage.__proto__ || Object.getPrototypeOf(DronesPage)).call(this, 'Drones'));
	    }

	    _createClass(DronesPage, [{
	        key: 'createElement',
	        value: function createElement() {
	            _get(DronesPage.prototype.__proto__ || Object.getPrototypeOf(DronesPage.prototype), 'createElement', this).call(this);
	        }
	    }, {
	        key: 'createElement',
	        value: function createElement() {
	            _get(DronesPage.prototype.__proto__ || Object.getPrototypeOf(DronesPage.prototype), 'createElement', this).call(this);
	            var headers = 'License Base Model AirTimeHours'.split(' ');
	            var t = new _dataTable.DataTable(headers, _app.application.dataService.drones);
	            t.appendToElement(this.element);
	        }
	    }, {
	        key: 'getElementString',
	...
	var MapPage = exports.MapPage = function (_Page) {
	    ...
	    _createClass(MapPage, [{
	        ...
	        value: function createElement() {
	            ...
	            var map = new _googleMap.GoogleMap(centerOfMap, _app.application.dataService.drones);
	...
	var GoogleMap = exports.GoogleMap = function (_BaseElement) {
	    ...
	    _createClass(GoogleMap, [{
	        ...
	        value: function createElement() {
	            ...
	            _get(GoogleMap.prototype.__proto__ || Object.getPrototypeOf(GoogleMap.prototype), 'createElement', this).call(this);
	            ...
	            setTimeout(function () {
	                ...
	                try {
	                    for (var _iterator = _this2.data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                        ...
	                        var _vehicle$latLong$spli2 = _slicedToArray(_vehicle$latLong$spli, 2);

	                        var lat = _vehicle$latLong$spli2[0];
	                        var long = _vehicle$latLong$spli2[1];
